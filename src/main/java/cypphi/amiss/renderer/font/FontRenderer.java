package cypphi.amiss.renderer.font;
...
public class FontRenderer {
    ...
    public FontRenderer(GlyphPage regularGlyphPage, GlyphPage boldGlyphPage, GlyphPage italicGlyphPage,
    ...
    public static FontRenderer create(String fontName, int size, boolean bold, boolean italic,
                                      boolean boldItalic) {
    ...
    public static FontRenderer createFromID(String id, int size, boolean bold, boolean italic,
                                            boolean boldItalic) {
        char[] chars = new char[256];
        ...
        try {
            font = Font.createFont(Font.TRUETYPE_FONT, FontRenderer.class.getResourceAsStream(id))
        ...
        try {
            if (bold) {
                boldPage = new GlyphPage(
                        Font.createFont(Font.TRUETYPE_FONT, FontRenderer.class.getResourceAsStream(id))
